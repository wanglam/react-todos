...
;(function(){
	...
	var TodoItem = React.createClass({displayName: "TodoItem",
		render:function(){
			...
			return (
				React.createElement("div", {class: "todoItem", style: {padding:5+"px",border:"1px solid gray"}}, 
					React.createElement("input", {type: "checkbox", style: {marginRight:"5px"}}), 
					React.createElement("span", {class: "show"}, this.props.text), 
					React.createElement("input", {class: "input", type: "text", value: this.props.text}), 
